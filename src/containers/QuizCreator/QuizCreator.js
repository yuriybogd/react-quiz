...
class QuizCreator extends Component {
    ...
    addQuestionHandler = event => {
        ...
        this.setState({isFormValid: false, rightAnswerId: 1, formControls: createFormControls()})
    ...
    createQuizHandler = event => {
        event.preventDefault()
            ...
            this.setState({quiz: [], isFormValid: false, rightAnswerId: 1, formControls: createFormControls()})
